...
RECOVERY_VERSION := ClockworkMod Recovery v2.5.1.0 SGS Edition
...
ifdef BOARD_SDCARD_INTERNAL_DEVICE
  LOCAL_CFLAGS += -DSDCARD_INTERNAL_DEVICE=\"$(BOARD_SDCARD_INTERNAL_DEVICE)\"
endif

ifdef BOARD_SDCARD_EXTERNAL_DEVICE
  LOCAL_CFLAGS += -DSDCARD_EXTERNAL_DEVICE=\"$(BOARD_SDCARD_EXTERNAL_DEVICE)\"
endif
...
ifdef BOARD_HAS_PARAMFS
   LOCAL_CFLAGS += -DHAS_PARAMFS
endif

ifdef BOARD_PARAMFS_DEVICE
  LOCAL_CFLAGS += -DPARAMFS_DEVICE=\"$(BOARD_PARAMFS_DEVICE)\"
endif

ifdef BOARD_PARAMFS_FILESYSTEM
  LOCAL_CFLAGS += -DPARAMFS_FILESYSTEM=\"$(BOARD_PARAMFS_FILESYSTEM)\"
endif
